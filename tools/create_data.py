...
def nuscenes_data_prep(root_path,
    ...
    # export 2d annotation coco format
    # nuscenes_converter.export_2d_annotation(
    ...
    if version == 'v1.0-trainval':  
        # create groundtruth database of 3d point cloud
...
if __name__ == '__main__':
    if args.dataset == 'kitti':
        ...
        #check the folder of test version exists or not
        # if not we can skip the test version
        if not osp.exists(osp.join(args.root_path, test_version)):
            print(f"Folder {test_version} does not exist. Skipping test version.")
        else:
            nuscenes_data_prep(
                root_path=args.root_path,
                info_prefix=args.extra_tag,
