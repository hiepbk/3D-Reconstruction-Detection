...
class DepthAnything3(nn.Module, PyTorchModelHubMixin):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: str, cache_dir: str | None = None, **kwargs):
        """
        Load a pretrained model from Hugging Face Hub or local directory.
        
        Args:
            pretrained_model_name_or_path: Model identifier from Hugging Face Hub or local path
            cache_dir: Directory to cache downloaded models. If None, uses default Hugging Face cache.
            **kwargs: Additional arguments passed to PyTorchModelHubMixin.from_pretrained
        
        Returns:
            DepthAnything3 model instance
        """
